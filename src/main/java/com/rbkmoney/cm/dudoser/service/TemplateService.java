...
public class TemplateService {
    ...
    private static final String TELEGRAM_FILE_CHANGE_WITHOUT_FILE_TEMPLATE = "vm/TelegramFileChangeWithoutFile.vm";
    ...
    private Template buildTemplateBasedOnType(ClaimData data) {
        switch (data.getTemplateType()) {
            ...
            case TELEGRAM_FILE_CHANGE_WITHOUT_FILE:
                return claimManagementTemplateEngine.getTemplate(TELEGRAM_FILE_CHANGE_WITHOUT_FILE_TEMPLATE);
